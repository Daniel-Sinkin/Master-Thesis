...
% Diagram palette aligned with existing thesis figures.
\definecolor{diagBlue}{HTML}{A5D8FF}
\definecolor{diagGreen}{HTML}{B2F2BB}
\definecolor{diagRed}{HTML}{FFC9C9}
\definecolor{diagYellow}{HTML}{FFE599}
\definecolor{diagGray}{HTML}{F2F2F2}
...
\usepackage{pdflscape}          % \begin{landscape} for rotated pages
...
\hypersetup{
  pdftitle={Closing the Bandwidth Gap: Custom CUDA Kernels for Tensor Network Contractions on A100 GPUs},
