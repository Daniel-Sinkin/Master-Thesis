...
\cref{sec:math-foundations}. This chapter uses that model directly and only
instantiates hardware-specific FP32 ridge points for the platforms in scope:
\[
...
\begin{figure}[H]
  ...
  \caption{Combined roofline envelopes for A100-SXM4-80GB and H100-SXM5-80GB
  using FP64 and FP32 ceilings. The H100 panel shifts both roofs upward and
  to higher operational intensity due to higher compute throughput and memory
  bandwidth.}
