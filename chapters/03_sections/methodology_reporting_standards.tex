...
The following rules define experiment execution and profiling. They also set
reporting requirements.
The goal is to keep optimisation claims traceable and reproducible across
kernels and optimisation stages.
