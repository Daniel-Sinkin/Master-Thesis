...
\begin{description}
  \item[K1 (SM throughput).] This counter reports how much total SM work was
  ...
  \item[K2 (DRAM throughput).] This measures bandwidth at the HBM interface as
  ...
  \item[K3 (L2 throughput).] This measures traffic pressure through the L2
  ...
  hierarchy dominates.
  \item[K4 (L1 hit rate).] This is the fraction of L1/texture requests served
  ...
  \item[K5 (FP32 FMA pipe active).] This reports how active the FP32 FMA
  ...
  \item[K6 (warps active).] This is runtime occupancy: active warps as a
  ...
  mostly stalled.
  \item[K7 (register occupancy limit).] This launch statistic captures how
  ...
  \item[K8 (warps eligible per cycle).] This counter measures how many warps
  ...
  \item[K9 (issue active).] This reports how often issue slots actually
  ...
  \item[K10 (thread-inst per inst).] This approximates average participating
...
This fixed KPI pack reduces trial-and-error profiler exploration and keeps
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.85\textwidth]{phenomena_register_pressure}
...
$100.0\%$ to $62.5\%$, increases runtime by about $12.9\%$, and reduces core
effective throughput from $14.46$ to $12.80\;\text{TFLOP/s}$ (about $11.5\%$).
