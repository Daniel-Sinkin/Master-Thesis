...
comparison between custom kernels and vendor-library baselines. In the current
draft, this setup supports exploratory and methodology-validation experiments
rather than a final workload-complete benchmark campaign.
...
The current workload suite includes:
...
tensor shapes, but they should be read as representative proxies for this
preparatory pass rather than as the final target-workload distribution.
