...
contractions, this overhead can dominate the total runtime. This section
...
Two observations follow from the data. First, the total time for separate
...
modest size, placing them squarely in the regime where launch overhead
dominates. By fusing these contractions into a single kernel using cuBLASDx's
