...
guidance for future optimisation cycles.
...
This supports prioritising layout transforms and contraction ordering that keep
the hottest contracted index unit-stride in memory.
