...
The main question is not just whether performance improved; it is which
mechanism caused the improvement (launch reduction, memory locality, occupancy
tuning, or precision-path choice). Profiling evidence is used to support each claim,
