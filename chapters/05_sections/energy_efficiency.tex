...
energy-to-solution is a co-equal operational objective in HPC: cluster power
...
redundant arithmetic, and avoidable memory traffic increase not only runtime but
also board energy. On A100-class GPUs, where arithmetic throughput is high and
...
This model is intentionally coarse, but it is sufficient for optimisation
...
\texttt{nvidia-smi} documentation~\cite{nvidia-smi-doc}. This workflow is
