...
This thesis treats tensor-network workloads from an HPC perspective. It
identifies the dominant bottlenecks on A100-class GPUs, applies
profile-guided optimisations, and measures performance against
vendor-library baselines. The main control variables are launch overhead,
memory-hierarchy efficiency, and occupancy-resource trade-offs.
