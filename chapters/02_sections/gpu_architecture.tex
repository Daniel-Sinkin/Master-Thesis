...
\begin{table}[H]
\centering
\caption{A100 KPI card (SXM4-40GB baseline) grouped by scope for performance
  modeling.}
...
\midrule
\multicolumn{3}{@{}l}{\textbf{Per processing core (SM sub-partition)}} \\
Processing core & Warp schedulers & \num{1} \\
Processing core & Warp dispatch units & \num{1} \\
Processing core & FP32 CUDA cores & \num{16} \\
Processing core & FP64 CUDA cores & \num{8} \\
Processing core & Tensor cores & \num{1} \\
Processing core & Maximum warps (derived) & \num{16} \\
Processing core & Maximum resident threads (derived) & \num{512} \\
\addlinespace[2pt]
\multicolumn{3}{@{}l}{\textbf{Per SM}} \\
SM & Processing cores (sub-partitions) & \num{4} \\
SM & FP32 CUDA cores & \num{64} \\
SM & FP64 CUDA cores & \num{32} \\
SM & Tensor cores & \num{4} \\
SM & Warp schedulers & \num{4} \\
SM & Warp dispatch units & \num{4} \\
SM & Maximum resident threads & \num{2048} \\
SM & Maximum resident warps & \num{64} \\
SM & Maximum resident blocks & \num{32} \\
SM & Register file (32-bit registers) & \num{65536} \\
SM & Shared memory (KB) & \num{164} \\
\addlinespace[2pt]
\multicolumn{3}{@{}l}{\textbf{Per GPU}} \\
GPU & Streaming multiprocessors (SMs) & \num{108} \\
GPU & Total processing cores (sub-partitions) & \num{432} \\
GPU & Maximum resident warps & \num{6912} \\
GPU & Maximum resident threads & \num{221184} \\
GPU & L2 cache (MB) & \num{40} \\
GPU & HBM capacity (GB) & \num{40} \\
GPU & Peak HBM bandwidth (GB/s) & \num{1555} \\
GPU & Base clock frequency (GHz) & \num{1.41} \\
\bottomrule
\end{tabularx}
\end{table}
...
Here, TPP denotes theoretical peak performance.
...
\midrule
\multicolumn{3}{@{}l}{\textbf{Per processing core (SM sub-partition)}} \\
Processing core & Peak FP32 performance (GFLOP/s) & \num{45.12} \\
Processing core & Peak FP64 performance (GFLOP/s) & \num{22.56} \\
Processing core & Maximum resident warps (derived) & \num{16} \\
Processing core & Maximum resident threads (derived) & \num{512} \\
\addlinespace[2pt]
\multicolumn{3}{@{}l}{\textbf{Per SM}} \\
SM & Peak FP32 performance (GFLOP/s) & \num{180.48} \\
SM & Peak FP64 performance (GFLOP/s) & \num{90.24} \\
SM & Tensor-core FP16 performance (TFLOP/s) & \num{2.89} \\
SM & Memory bandwidth share (GB/s) & \num{14.40} \\
SM & Arithmetic-intensity threshold FP32 (FLOPs/byte) & \num{12.5} \\
SM & Arithmetic-intensity threshold FP64 (FLOPs/byte) & \num{6.2} \\
\addlinespace[2pt]
\multicolumn{3}{@{}l}{\textbf{Per GPU}} \\
GPU & Bandwidth-based FP64 ceiling (1 FLOP/value) (GFLOP/s) & \num{194.4} \\
GPU & Bandwidth-based FP32 ceiling (1 FLOP/value) (GFLOP/s) & \num{388.8} \\
GPU & Total FP32 CUDA cores & \num{6912} \\
GPU & Total FP64 CUDA cores & \num{3456} \\
GPU & Total processing cores (sub-partitions) & \num{432} \\
GPU & Maximum resident warps & \num{6912} \\
GPU & Maximum resident threads & \num{221184} \\
\bottomrule
