...
this work, representative of modern multi-GPU HPC nodes.
...
closed-form penalty expressions are moved to \cref{app:hardware-context} to keep
this chapter focused on the execution concepts needed for reading the benchmark
results.
