...
\SI{14}{\nano\second}$), which gives a $\approx 3\times$ row-switch cost in the
same way as the \num{16}/\num{16}/\num{16}-cycle example used in
the NVIDIA GTC explanation (\num{48} cycles for switch versus \num{16} for a
column read)~\cite{li2018highspeed-dram,jones2022cuda-how-works}.
