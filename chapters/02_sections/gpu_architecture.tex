...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{RowColumnAccessor}
  \caption{Custom schematic for HBM/DRAM row-column access. A read activates one
