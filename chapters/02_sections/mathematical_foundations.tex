...
This section fixes notation for the performance models and error bounds
used throughout the thesis. It is not a full treatment; just enough to
make the later measurements and precision arguments self-contained.
