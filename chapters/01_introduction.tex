...
The goal is practical: build a profiling-driven kernel-optimisation workflow
that produces measurable speedups for tensor-network contraction workloads on
current JSC hardware and can be carried over to next-generation accelerators.
...
The thesis addresses these questions with a measurement-first workflow based on
reproducible benchmarks and Nsight profiling. Custom kernels are compared
